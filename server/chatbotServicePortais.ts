...
- ESCOVAS: Já NÃO existe objetivo mínimo de escovas. A loja recebe comissão (10% do valor faturado) por cada escova vendida, a partir da 1.ª escova. O objetivo nacional é 30% de serviços com venda de escovas, mas não é obrigatório para receber comissão.
...
- Quando perguntam sobre "taxa de escovas", "percentagem de escovas", "estamos a cumprir escovas" - informa que não há mínimo obrigatório, a comissão é por escova vendida. O objetivo nacional é 30%.
