...
- Responde APENAS com o JSON, sem texto adicional`;
  ...
  portalVolante: router({
    ...
    // Obter estatísticas detalhadas por meses específicos
    getEstatisticasDetalhadasPorMeses: publicProcedure
      .input(z.object({
        token: z.string(),
        meses: z.array(z.object({
          mes: z.number().min(1).max(12),
      ...
      .query(async ({ input }) => {
        ...
        const estatisticas = await db.getEstatisticasDetalhadasVolantePorMeses(
          tokenData.volante.id,
          input.meses
        );
        return estatisticas;
    ...
    // Obter top lojas com mais visitas
    getTopLojasComMaisVisitas: publicProcedure
      .input(z.object({
        token: z.string(),
        meses: z.array(z.object({
          mes: z.number().min(1).max(12),
      ...
      .query(async ({ input }) => {
        ...
        const topLojas = await db.getTopLojasComMaisVisitas(
          tokenData.volante.id,
          input.meses,
          input.limite || 5
        );
    ...
    // Obter top lojas com mais serviços (por meses)
    getTopLojasComMaisServicosPorMeses: publicProcedure
      .input(z.object({
        token: z.string(),
        meses: z.array(z.object({
          mes: z.number().min(1).max(12),
      ...
      .query(async ({ input }) => {
        ...
        const topLojas = await db.getTopLojasComMaisServicosPorMeses(
          tokenData.volante.id,
          input.meses,
          input.limite || 5
        );
    ...
    getAnaliseRentabilidade: publicProcedure
      ...
      .query(async ({ input }) => {
        ...
        const rentabilidade = await db.getAnaliseRentabilidade(
          tokenData.volante.id,
          input.meses,
          input.limite || 10
        );
