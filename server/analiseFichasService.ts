...
function gerarHTMLRelatorio(relatorio: RelatorioLoja): string {
  ...
  // FS com notas antigas - REMOVIDO a pedido do utilizador (rubrica sem utilidade)
    ...
    <tr>
      <td align="center" style="padding: 20px;">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="background: #ffffff; border-radius: 8px; overflow: hidden;">
          ...
          ${(relatorio.fichasAbertas5Dias + relatorio.fichasAposAgendamento + relatorio.fichasStatusAlerta + relatorio.fichasSemNotas) > 0 ? `
          <tr>
