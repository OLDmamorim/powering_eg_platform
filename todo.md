...
## v6.16.0 - Dashboard de Produtividade do Volante
- [x] Criar página ProdutividadeVolante.tsx
- [x] Adicionar gráfico de evolução de serviços por tipo (Chart.js - linha temporal)
- [x] Adicionar gráfico de ranking de lojas mais atendidas (Chart.js - barras horizontais)
- [x] Cards com totais por tipo de serviço (Substituição, Reparação, Calibragem, Outros)
- [x] Filtros por período (Mês Atual, Mês Anterior, Trimestre Anterior)
- [x] Adicionar rota e link no menu do Portal do Volante
- [x] Testar funcionalidade completa

## v6.17.0 - Relatórios Mensais Automáticos de Serviços
- [x] Criar tabela envios_relatorios_servicos (histórico de envios)
- [x] Criar serviço de geração de PDF de relatório mensal (para gestor)
- [x] Criar serviço de geração de PDF de relatório mensal (para loja)
- [x] Implementar envio automático no último dia do mês às 23:00
- [x] PDF para gestor: resumo completo de todos os serviços do volante
- [x] PDF para cada loja: serviços executados nessa loja específica
- [ ] Página de histórico de envios com tabela profissional (opcional)
- [ ] Funcionalidade de reenvio de relatórios anteriores (opcional)
- [x] Testar envios automáticos

## v6.17.1 - CRÍTICO: Corrigir Leitura de Token do URL
- [x] Adicionar leitura de token do URL query parameter no PortalLoja.tsx
- [x] Testar acesso via links com token no URL
