...
import { Building2, Calendar, User, ChevronDown, ChevronUp, FileText, ClipboardList } from "lucide-react";
        ...
        <Tabs defaultValue="livres" className="space-y-4">
          <TabsList>
            <TabsTrigger value="livres">
              ...
              Relatórios Livres ({relatoriosLivres?.length || 0})
            </TabsTrigger>
            <TabsTrigger value="completos">
              <ClipboardList className="h-4 w-4 mr-2" />
              Relatórios Completos ({relatoriosCompletos?.length || 0})
            </TabsTrigger>
          </TabsList>
