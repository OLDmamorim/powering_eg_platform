...
export function HistoricoEnviosRecalibra() {
  ...
  return (
    <div className="space-y-3">
      {historico.map((envio) => {
        ...
        return (
          <div key={envio.id} className="flex items-center justify-between p-4 bg-muted rounded-lg border-l-4 border-orange-500">
                ...
                <div>
                  ...
                  <div className="font-medium">
                    ...
                    <span className="text-xs text-muted-foreground ml-2">
                      ({envio.emailsEnviadosUnidades} unidades + {envio.emailsEnviadosGestores} gestores)
                    </span>
                  </div>
                </div>
              </div>
