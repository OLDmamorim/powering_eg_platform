  ...
  const groups: MenuGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: BarChart3, label: 'Dashboard Volantes', path: "/dashboard-volantes", show: isGestor || isAdmin, showBadge: false },
        { icon: CalendarDays, label: 'Calendário Volantes', path: "/calendario-volantes", show: isGestor || isAdmin, showBadge: false },
        { icon: Route, label: 'Log Atribuições', path: "/log-atribuicoes", show: isGestor || isAdmin, showBadge: false },
        ...
        { icon: Key, label: 'API Keys', path: "/api-keys", show: isAdmin, showBadge: false },
      ]
    },
    {
      id: 'reports',
      ...
      items: [
        ...
        { icon: Sparkles, label: tr('menu.items.relatoriosIA', 'Relatórios'), path: "/relatorios-ia", show: true, showBadge: false },
        { icon: History, label: tr('menu.items.historicoIA', 'Histórico'), path: "/historico-relatorios-ia", show: isGestor, showBadge: false },
